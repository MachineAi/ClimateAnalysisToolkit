...
namespace ClimateAnalysis
{
    ...
    public class RectangleDrawing
    {
        ...
        private void DisableLayerSelection()
        {
            ...
            {
                if (lay.LegendText != "Search Rectangle")
                {
        ...
        private void AddRectangleLayer()
        {
            ...
            if (_rectangleLayer == null)
            {
                ...
                _rectangleLayer = new MapPolygonLayer(rectangleFs) { LegendText = "Search Rectangle" };
        ...
        {
            return _mainMap.GetAllLayers().Cast<IMapLayer>().Any(lay => lay.LegendText == "Search Rectangle");
        }
